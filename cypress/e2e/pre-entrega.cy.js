...
describe("PRE ENTREGA ", () =>{
    let registroData, productosData, totalSum, priceProduct2, priceProduct1
    ...
    shoppingCartPage.checkProductName(productosData.secondProduct.product2).should('have.text', productosData.secondProduct.product2)
     ...
     priceProduct1 = (productosData.firstProduct.product1,productosData.firstProduct.price1)
     priceProduct2 = (productosData.secondProduct.product2, productosData.secondProduct.price2)
     totalSum =  priceProduct1 + priceProduct2
